...
//        Log.d("ybyb", "푸시 알림 받음 MyFirebaseMessageingService")
//
//        //메세지에 데이터 페이로드가 포함되어 있는지 확인
//        //페이로드 -> 전송된 데이터
//        //데이터 값이 있는지 없는지 확인할 때 쓰임
//        if (remoteMessage.data.isNotEmpty()) {
//            Log.d("ybyb", "Message data payload -> ${remoteMessage.data}")
//            Log.d("ybyb","remoteMessage ->${remoteMessage.data.toString()}")
...
//            Log.d("ybyb", "Message Notification Body -> ${it.body}")
//
//        }
...
//        Log.d("ybyb", "MessagingService -> sendRegistrationTokenToServer($token)")
//
//    }
//

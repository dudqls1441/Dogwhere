...
//                //네트워크 문제
//                Toast.makeText(view.context, "지오코더 서비스 사용불가", Toast.LENGTH_LONG).show()
//                return "지오코더 서비스 사용불가"
//            } catch (illegalArgumentException: IllegalArgumentException) {
//                Toast.makeText(view.context, "잘못된 GPS 좌표", Toast.LENGTH_LONG).show()
//                return "잘못된 GPS 좌표"
//            }
//            if (addresses == null || addresses.size == 0) {
//                Toast.makeText(view.context, "주소 미발견", Toast.LENGTH_LONG).show()
//                return "주소 미발견"
//            }

...
class BBS_TransactionItem(val title :String,val content:String, val username:String,val time:String,
                          val price:String, val uid:String, val oid:String,val img :String ,val heartCnt :Int,
    ...
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        ...
        Glide.with(viewHolder.itemView).load(img).into(viewHolder.itemView.imformation_bbs_img)

...
import kotlinx.android.synthetic.main.my_registered_matching_item.view.main_RelativeLayout
import kotlinx.android.synthetic.main.my_registered_matching_item.view.matching_RemainingTime
import kotlinx.android.synthetic.main.my_registered_matching_item.view.text_place
import kotlinx.android.synthetic.main.my_registered_matching_item.view.text_time
import kotlinx.android.synthetic.main.my_registered_matching_item.view.text_title
import org.jetbrains.anko.backgroundResource
import java.text.SimpleDateFormat
import java.util.*


class Matching_Registered_List_Item(
    ...
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        ...
        setting(viewHolder,position)
    }

    override fun getLayout(): Int {
        return R.layout.my_registered_matching_item
    }

    private fun setting(viewHolder: GroupieViewHolder, position: Int){
